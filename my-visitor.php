...
$res = mysqli_query ($con, "Select * From visitor where Unit_ID = '$session_unit' order by Date desc;");
?>
...
<body>
  ...
  <article>
	...
	while($r = mysqli_fetch_array($res)){ ?>
  		<div class="gallery">
  		<br>
    			<img src="images/user.svg"  width="200" height="100" class="center">

  			<div class="desc"> 
  				<h4><font color="blue">Unit ID</font>&nbsp;&nbsp;<?php echo $r['Unit_ID'] ?></h4>
  				<h4><font color="blue">Name</font>&nbsp;&nbsp;<?php echo $r['Name'] ?></h4>
	...
	<?php } 
          ...
          echo "<h4>No Registered Visitor</h4> Click <u><a href='register-visitor.php'>here</a></u> to make one!";
      } 
  ?>
</div>
  </article>
