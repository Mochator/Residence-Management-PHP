<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    //$userid = mysqli_real_escape_string($con, $_POST['User_ID']);  
  	...
  	$sql = "INSERT INTO package_receive (Receiver_name, Remarks, User_ID, Unit_ID, Status) VALUES ('$receivername', '$remarks', '$userid', '$unitid', 'Pending');";    
  	// execute query
...
<html>
<head>
<title>UPTOWN | Package Request</title>
...
<div class="wrapper">
  ...
  <article>
<h1>Package Receives Form</h1>
<div class="content">
<div class="container1">
  <form method="post">
    <b><label for="fname">Reciever Name</label></b>
    <input type="text" id="" name="Receiver_name" placeholder="Your name.." required="required">

    <b><label for="subject">Remarks</label></b>
    <textarea id="" name="Remarks" placeholder="Write something.." style="height:200px; font-family:Arial, Helvetica, sans-serif;"></textarea>
    <br><br>
